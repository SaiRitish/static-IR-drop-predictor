...
model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001), loss=custom_loss, metrics=["mae", "mse"])
...
history = model.fit(train_ds, validation_data=test_ds, epochs=400)
